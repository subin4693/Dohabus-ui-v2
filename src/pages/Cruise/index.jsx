  ...
  return (
    <div>
      ...
      <section className="mb-5 px-16 mt-5">
        ...
        >
          {lang === "en" ? "Cruise Packages" : "اكتشف الجولات الشهيرة"}
        </motion.h2>
        <Link to={"/contact"}>
              ...
              >
                ...
                <div className="w-[300px]">
                  ...
                  <h2 className="mt-3 flex gap-2 items-center">
                    ...
                    <span>
                      {" "}
                      <FaShip className="text-gray-500" size={22} />
                    </span>
                    <p>{card.cruiseName}</p>
                  </h2>
                  <h2 className="mt-3 flex gap-2 items-center">
                    {" "}
                    <span>
                      <FaMapMarkerAlt className="text-gray-500" size={22} />
                    </span>
                  ...
                  <h2 className="mt-3 flex gap-2 items-center">
                    {" "}
                    <span>
                      <FaMoon className="text-gray-500" size={22} />
                    </span>
                    <p>{card.numberOfNights} Nights</p>
                  </h2>
                  <h2 className="mt-3 flex gap-2">
                    <span>
                      <FaAnchor className="text-gray-500" size={22} />
                    </span>
                    <p className="h-[100px] overflow-hidden">
                      {card.stops
                        ?.map((location) => location[lang])
                        .join(" | ")}
                    </p>
                  </h2>

    ...
    >
      ...
      >
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <h1 className="text-6xl p-5 text-center font-semibold">
            Discover Our Tours
          </h1>
        ...
        <div className="p-10 flex justify-center items-center flex-wrap">
          <div className="relative w-[70vh] h-[40vh]">
            <iframe
        ...
        <div className="pt-20 flex justify-between p-10 flex-wrap ">
          <div className="w-[100vh] flex flex-col justify-center p-5">
            <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-semibold mb-5">
            ...
            <button
              type="button"
              className="w-[300px] p-4 rounded-2xl bg-black text-white hover:bg-gray-800 duration-300"
            >

        ...
        try {
            ...
            if (isEdit) {
                ...
                const res = await axios.put(
                    `${BASE_URL}/couries/${selectedData._id}`,
                    {
                        title,
                        coverImage: image,
                        operatorName,
                    ...
                    <div className="bg-white shadow-lg rounded-lg flex flex-col md:flex-row w-full md:w-[800px] gap-4 p-5 border shadow-xl">
                        ...
                        <div className="flex-1 space-y-5">
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setOperatorName((prev) => e.target.value)
                                }
                            ...
                            <input
                                ...
                                value={cruiseName}
                                onChange={(e) =>
                                    setCruiseName((prev) => e.target.value)
                                }
                            ...
                            {stops.map((stop, index) => (
                                <div key={index} className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        value={stop.ar}
                                        onChange={(e) =>
                                            handleStopChange(e, index, "ar")
                                        }
                                        placeholder={`التوقف ${
                                            index + 1
                                        } (بالعربية)`} // Placeholder in Arabic
                                        className="w-full p-2 border border-black rounded-lg outline-none"
                                    />
                                </div>
                            ))}

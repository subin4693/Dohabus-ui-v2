  ...
  const handleCreate = async (isEdit) => {
    ...
    try {
      ...
      if (isEdit) {
        ...
        const res = await axios.put(`${BASE_URL}/hotels/${selectedData._id}`, {
          title,
          description,
          coverImage: image,
        });
    ...
    <div>
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-small text-red">Manage your tour Hotels</p>
        </div>
        <div>
      ...
      <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-3 gap-10 flex-wrap">
        ...
        {categories.map((card) => (
          <Card
            ...
            description={
              card.description ? card.description[lang] : "Default Description"
            }

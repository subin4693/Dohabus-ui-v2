    ...
    <div className="fixed inset-0 flex justify-center items-center bg-custom-yellow-light z-20">
      ...
      >
        ...
        <div>
          ...
          {progressGallery > 0 && <p>Upload progress: {progressGallery}%</p>}
          {errorGallery && (
            <p className="text-red-500">Error: {errorGallery.message}</p>
          )}
        </div>
        ...
        <div>
          ...
          {progressVideo > 0 && <p>Upload progress: {progressVideo}%</p>}
          {errorVideo && (
            <p className="text-red-500">Error: {errorVideo.message}</p>
          )}
        </div>

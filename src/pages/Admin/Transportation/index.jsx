...
const Transportation = () => {
  ...
  const handleDownload = () => {
    ...
    details.forEach((item) => {
      const { _id, title, type, passenger, luggage, isActive, createdAt } =
        item;
      const rowData = [
        _id,
        title.en,
      ...
      {mainUser && mainUser.role === "super-admin" && (
        <div className=" flex justify-between flex-wrap">
          ...
          <div className=" flex gap-5">
            ...
            <Link to={"/admin/transportations-bookings"}>
              <button className="bg-blue-500 text-white p-2 rounded-lg mb-4">
                Bookings
              </button>
            </Link>
          </div>
